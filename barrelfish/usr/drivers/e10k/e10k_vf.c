...
static void queue_hw_init(uint8_t n)
{
    ...
    e10k_vf_vftxdctl_pthresh_wrf(d, n, 8); // FIXME: Figure out what the right number
                                      //        is here.
    // Mohan from the intel 82599 datasheet: page 606
    e10k_vf_vftxdctl_hthresh_wrf(d, n, 0);      // htresh should be non-zero if pthresh is non-zero
