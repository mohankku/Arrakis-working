...
static errval_t ip_filter(uint64_t qid, uint64_t* fid)
{
    e10k_flt_etype_setup(0, (int) qid, 0x0800);
    *fid = 0;
...
static void queue_hw_init(uint8_t n)
{
    ...
    e10k_srrctl_1_bsz_hdr_wrf(d, n, 128 / 64); // TODO: Do 128 bytes suffice in all cases?
