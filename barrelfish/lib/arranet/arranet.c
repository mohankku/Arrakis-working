...
static struct peer peers[MAX_PEERS] = {
    {
        ...
        .mac.addr = "\x00\x1b\x21\xbc\x87\x3c",
    },
    {
        // XXX: This needs to be updated each time the tap interface is re-initialized
        /* .ip = 0x0102000a,       // 10.0.2.1 */
        .ip = 0x0f00000a,
        /* .mac.addr = "\x86\x86\x0b\xda\x22\xd7", */
        .mac.addr = "\x00\x1b\x21\xbc\x87\x3d",
    },
    {
        // XXX: This needs to be updated each time the tap interface is re-initialized
        /* .ip = 0x0164a8c0,       // 192.168.100.1 */
        .ip = 0x0700000a,
        .mac.addr = "\x00\x15\x4d\x13\x1a\x44",
    },
    {
        .ip = 0x0a00000a,       // 128.208.6.175 - swingout2
        .mac.addr = "\x22\xc9\xfc\x96\x83\xfc",
    },
    {
...
static struct mac2ip ip_config[] = {
    {   // self port 0
        .mac = "\x00\x1b\x21\xbc\x87\x3c",
        /* .ip = 0x0a00020f,       // 10.0.2.15 */
        /* .ip = 0xc0a8640f,       // 192.168.100.15 */
        .ip = 0x0a000006,
    },
    {   // self port 1
        .mac = "\x00\x1b\x21\xbc\x87\x3d",
        /* .ip = 0x0a00020f,       // 10.0.2.15 */
        /* .ip = 0xc0a8640f,       // 192.168.100.15 */
        .ip = 0x0a00000f,
    },
    {
        // ratbat
        .mac = "\x00\x15\x4d\x13\x1a\x44",
        .ip = 0x0a000007,       // 192.168.1.2
    },
...
void lwip_arrakis_start(int *argc, char ***argv)
{
	...
	assert(err_is_ok(err));
        ...
        assert(err_is_ok(err));
        /* printf("enabled vtd done\n"); */
    }

    /* printf("enabled init start\n"); */
    e1000n_driver_init(*argc, *argv);
    /* printf("enabled init done\n"); */

    /* printf("enabled mac start\n"); */
    ...
    if(arranet_myip == 0) {
        ...
        printf("IP address configured %d\n", arranet_myip);
    }
